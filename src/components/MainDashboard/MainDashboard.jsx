...
import Expenses from "../Forms/Expenses/Expenses";
import Modal from "../Modal/Modal";
import WalletBalance from "../Forms/WalletBalance/WalletBalance";
  ...
  return (
    <div className={styles.container}>
      ...
      <Modal isOpen={isOpenBalance} setIsOpen={setIsOpenBalance}>
        <WalletBalance setIsOpen={setIsOpenBalance} setBalance={setBalance} />
      </Modal>
    </div>
  );
};
